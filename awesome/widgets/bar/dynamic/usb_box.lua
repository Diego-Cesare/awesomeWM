...
local function monitor_usb()
  awful.spawn.with_line_callback("udevadm monitor --udev --subsystem-match=usb --property", {
    stdout = function(line)
      if string.find(line, "ACTION=add") then
        os.execute("mpg123 ~/.config/awesome/themes/songs/device.mp3 &")
